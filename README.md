...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-maptools-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-maptools-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-maptools-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-maptools-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-maptools-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-maptools-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-maptools/badges/version.svg)](https://anaconda.org/conda-forge/r-maptools)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-maptools/badges/downloads.svg)](https://anaconda.org/conda-forge/r-maptools)
